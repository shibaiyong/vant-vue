...
<van-panel>
    ...
    <div class="banklist" @click="linkTo('/bank/banklist')">银行列表<van-icon name="arrow"/></div>
    <div class="ticket" @click="linkTo('bank/ticketlist')">优惠券<van-icon name="arrow"/></div>

    <!-- <div class="banklist">优惠券详情</div> -->
