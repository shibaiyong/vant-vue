...
export const getBankList = data => {
  return request.post('/wx/ruielife/bank/list',data).then(res => res.data)  //银行列表
}


export const bankAdd = data => {
  return request.post('/wx/ruielife/bank/add',data).then(res => res.data)  //新增银行
}

export const bankDelete = param => {

  return request({
    url: "/wx/ruielife/bank/delete",
    method: 'delete',
    params: param
  }).then(res=>Promise.resolve(res.data))//删除银行
}

export const bankUpdate = params => {
  return request({
    url: '/wx/ruielife/bank/update',//编辑银行
    method: 'patch',
    data:params
  }).then(res=>Promise.resolve(res.data))
}

export const bankUserUpdate = params => {
  return request({
    url: '/wx/ruielife/bank/updateUserBank',//我的银行-编辑
    method: 'patch'
  })
}
